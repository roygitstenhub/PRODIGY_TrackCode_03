...
const Footer = () => {
    ...
    return (
        <div className="flex min-h-16 mb-3 px-3 flex-wrap items-center xs-mx:gap-2 justify-evenly md-mx:text-xs text-sm">
            ...
            <div className="">All Right reserved by Ekart & <a href="https://github.com/roygitstenhub" className=" text-red-500 hover:text-red-800 cursor-pointer transform transition-transform mb-1 duration-[400ms] underline">Roysten</a> | {new Date().getFullYear()}</div>
        </div>
    )
}
