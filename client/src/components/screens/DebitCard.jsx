    ...
    return (
        <div className="flex xs-mx:min-h-48 w-full sm-mx:min-h-60 min-h-80 my-2 p-4 bg-orange-100 justify-evenly items-center">
            ...
            <div className="relative">
                <img className="xs-mx:hidden md-mx:w-[28vw] lg-mx:w-[35vw] -rotate-[30deg] z-10" src="/assets/debitcard1.png" />
                <img className="xs-mx:hidden md-mx:w-[28vw] lg-mx:w-[35vw] absolute top-4 -right-4 -rotate-[20deg]" src="/assets/debitcard2.png" />
            </div>
        </div>
    )
}
