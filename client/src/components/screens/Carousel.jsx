      ...
      <Slider {...settings} ref={sliderRef}>
        {
          offers.map((x, index) =>
            <div key={index} className=" cursor-pointer  overflow-hidden">
              <img src={`/assets/img${x}.jpg`} alt="Slide" className="w-auto sm-mx:!hidden object-cover min-h-[30vh] " />
              <img src={`/assets/smallimg${x}.jpg`} alt="Slide" className="w-auto sm:!hidden object-cover min-h-[30vh] " />
            </div>
          )
        }
      </Slider>
